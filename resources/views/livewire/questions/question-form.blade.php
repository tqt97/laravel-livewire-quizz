                ...
                <div class="p-6 text-gray-900">
                    <form wire:submit="save">
                        <div>
                            ...
                            <x-textarea wire:model="question_text" id="question_text" class="block mt-1 w-full"
                                type="text" name="question_text" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-textarea wire:model="answer_explanation" id="answer_explanation"
                        ...
                        <div class="mt-4">
                            ...
                            @foreach($questionOptions as $index => $questionOption)
                                <div class="flex mt-2">
                                    <x-text-input type="text" wire:model="questionOptions.{{ $index }}.option"
